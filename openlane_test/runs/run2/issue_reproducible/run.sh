...
export EXTRA_LIBS='openlane/designs/test/macros/test_sram.lib';
...
export SAVE_NETLIST='./results/synthesis/top_test.v';
...
export VERILOG_FILES='openlane/designs/test/src/top_test.v';
