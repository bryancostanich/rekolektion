...
set ::env(CTS_CURRENT_DEF) "/openlane/designs/test/runs/run4/results/placement/top_test.def"
...
set ::env(CURRENT_DEF) "/openlane/designs/test/runs/run4/tmp/routing/26-fill.def"
set ::env(CURRENT_DIR) "/openlane/designs/test/runs/run4/tmp/routing"
set ::env(CURRENT_GUIDE) "/openlane/designs/test/runs/run4/tmp/routing/23-global.guide"
set ::env(CURRENT_INDEX) "27"
set ::env(CURRENT_LIB) "/openlane/designs/test/runs/run4/results/signoff/top_test.lib"
set ::env(CURRENT_NETLIST) "/openlane/designs/test/runs/run4/tmp/routing/26-fill.nl.v"
set ::env(CURRENT_ODB) "/openlane/designs/test/runs/run4/tmp/routing/26-fill.odb"
set ::env(CURRENT_POWERED_NETLIST) "/openlane/designs/test/runs/run4/tmp/routing/26-fill.pnl.v"
set ::env(CURRENT_SDC) "/openlane/designs/test/runs/run4/tmp/21-top_test.sdc"
set ::env(CURRENT_SDF) "/openlane/designs/test/runs/run4/results/signoff/top_test.sdf"
...
set ::env(GLB_CFG_FILE) "/openlane/designs/test/runs/run4/config.tcl"
...
set ::env(GRT_CONGESTION_REPORT_FILE) "/openlane/designs/test/runs/run4/tmp/routing/groute-congestion.rpt"
...
set ::env(LAST_TIMING_REPORT_TAG) "/openlane/designs/test/runs/run4/reports/synthesis/2-syn_sta"
set ::env(LEFT_MARGIN_MULT) "12"
set ::env(LIB_CTS) "/openlane/designs/test/runs/run4/tmp/cts/cts.lib"
set ::env(LIB_CTS_FASTEST) "/openlane/designs/test/runs/run4/tmp/cts/cts-fastest.lib"
set ::env(LIB_CTS_SLOWEST) "/openlane/designs/test/runs/run4/tmp/cts/cts-slowest.lib"
...
set ::env(LIB_SYNTH) "/openlane/designs/test/runs/run4/tmp/synthesis/trimmed.lib"
set ::env(LIB_SYNTH_COMPLETE) "/root/.volare/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib"
set ::env(LIB_SYNTH_COMPLETE_NO_PG) "/openlane/designs/test/runs/run4/tmp/synthesis/1-sky130_fd_sc_hd__tt_025C_1v80.no_pg.lib"
set ::env(LIB_SYNTH_MERGED) "/openlane/designs/test/runs/run4/tmp/synthesis/merged.lib"
set ::env(LIB_SYNTH_NO_PG) "/openlane/designs/test/runs/run4/tmp/synthesis/1-trimmed.no_pg.lib"
...
set ::env(LOGS_DIR) "/openlane/designs/test/runs/run4/logs"
...
set ::env(MERGED_LEF) "/openlane/designs/test/runs/run4/tmp/merged.nom.lef"
set ::env(MERGED_LEF_MAX) "/openlane/designs/test/runs/run4/tmp/merged.max.lef"
set ::env(MERGED_LEF_MIN) "/openlane/designs/test/runs/run4/tmp/merged.min.lef"
...
set ::env(PLACEMENT_CURRENT_DEF) "/openlane/designs/test/runs/run4/results/floorplan/top_test.def"
...
set ::env(REPORTS_DIR) "/openlane/designs/test/runs/run4/reports"
set ::env(RESULTS_DIR) "/openlane/designs/test/runs/run4/results"
...
set ::env(ROUTING_CURRENT_DEF) "/openlane/designs/test/runs/run4/tmp/cts/18-top_test.resized.def"
...
set ::env(RUN_CTS) "1"
set ::env(RUN_CVC) "1"
set ::env(RUN_DIR) "/openlane/designs/test/runs/run4"
set ::env(RUN_DRT) "1"
...
set ::env(SAVE_DEF) "/openlane/designs/test/runs/run4/results/routing/top_test.def"
set ::env(SAVE_NETLIST) "/openlane/designs/test/runs/run4/results/routing/top_test.nl.v"
set ::env(SAVE_ODB) "/openlane/designs/test/runs/run4/results/routing/top_test.odb"
set ::env(SAVE_POWERED_NETLIST) "/openlane/designs/test/runs/run4/results/routing/top_test.pnl.v"
...
set ::env(START_TIME) "2026.03.27_03.17.27"
...
set ::env(TMP_DIR) "/openlane/designs/test/runs/run4/tmp"
set ::env(TOP_MARGIN_MULT) "4"
set ::env(TRACKS_INFO_FILE) "/root/.volare/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tracks.info"
set ::env(TRACKS_INFO_FILE_PROCESSED) "/openlane/designs/test/runs/run4/tmp/routing/config.tracks"
...
set ::env(YOSYS_OUT) "/openlane/designs/test/runs/run4/tmp/synthesis/blackbox/extra.v"
set ::env(YOSYS_REWRITE_VERILOG) "0"
set ::env(_PROPAGATE_ALL_CLOCKS) "0"
set ::env(__PL_SKIP_IO) "1"
set ::env(_tmp_drt_file_prefix) "/openlane/designs/test/runs/run4/tmp/routing/drt"
set ::env(_tmp_drt_rpt_prefix) "/openlane/designs/test/runs/run4/reports/routing/drt"
set ::env(cts_logs) "/openlane/designs/test/runs/run4/logs/cts"
set ::env(cts_reports) "/openlane/designs/test/runs/run4/reports/cts"
set ::env(cts_results) "/openlane/designs/test/runs/run4/results/cts"
set ::env(cts_tmpfiles) "/openlane/designs/test/runs/run4/tmp/cts"
set ::env(floorplan_logs) "/openlane/designs/test/runs/run4/logs/floorplan"
set ::env(floorplan_reports) "/openlane/designs/test/runs/run4/reports/floorplan"
set ::env(floorplan_results) "/openlane/designs/test/runs/run4/results/floorplan"
set ::env(floorplan_tmpfiles) "/openlane/designs/test/runs/run4/tmp/floorplan"
set ::env(fp_report_prefix) "/openlane/designs/test/runs/run4/reports/floorplan/3-initial_fp"
set ::env(placement_logs) "/openlane/designs/test/runs/run4/logs/placement"
set ::env(placement_reports) "/openlane/designs/test/runs/run4/reports/placement"
set ::env(placement_results) "/openlane/designs/test/runs/run4/results/placement"
set ::env(placement_tmpfiles) "/openlane/designs/test/runs/run4/tmp/placement"
set ::env(routing_logs) "/openlane/designs/test/runs/run4/logs/routing"
set ::env(routing_reports) "/openlane/designs/test/runs/run4/reports/routing"
set ::env(routing_results) "/openlane/designs/test/runs/run4/results/routing"
set ::env(routing_tmpfiles) "/openlane/designs/test/runs/run4/tmp/routing"
set ::env(signoff_logs) "/openlane/designs/test/runs/run4/logs/signoff"
set ::env(signoff_reports) "/openlane/designs/test/runs/run4/reports/signoff"
set ::env(signoff_results) "/openlane/designs/test/runs/run4/results/signoff"
set ::env(signoff_tmpfiles) "/openlane/designs/test/runs/run4/tmp/signoff"
set ::env(synth_report_prefix) "/openlane/designs/test/runs/run4/reports/synthesis/1-synthesis"
set ::env(synthesis_logs) "/openlane/designs/test/runs/run4/logs/synthesis"
set ::env(synthesis_reports) "/openlane/designs/test/runs/run4/reports/synthesis"
set ::env(synthesis_results) "/openlane/designs/test/runs/run4/results/synthesis"
set ::env(synthesis_tmpfiles) "/openlane/designs/test/runs/run4/tmp/synthesis"
set ::env(timer_end) "1774581470"
set ::env(timer_start) "1774581447"
