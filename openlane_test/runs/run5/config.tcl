...
set ::env(CORE_AREA) "5.52 10.88 194.12 236.64"
...
set ::env(CTS_CURRENT_DEF) "/openlane/designs/test/runs/run5/results/placement/top_test.def"
...
set ::env(CURRENT_DEF) "/openlane/designs/test/runs/run5/results/routing/top_test.def"
set ::env(CURRENT_DIR) "/openlane/designs/test/runs/run5/tmp/routing"
set ::env(CURRENT_GDS) "/openlane/designs/test/runs/run5/results/signoff/top_test.gds"
set ::env(CURRENT_GUIDE) "/openlane/designs/test/runs/run5/tmp/routing/23-global.guide"
set ::env(CURRENT_INDEX) "37"
set ::env(CURRENT_LIB) "/openlane/designs/test/runs/run5/results/signoff/top_test.lib"
set ::env(CURRENT_NETLIST) "/openlane/designs/test/runs/run5/results/routing/top_test.nl.v"
set ::env(CURRENT_ODB) "/openlane/designs/test/runs/run5/results/routing/top_test.odb"
set ::env(CURRENT_POWERED_NETLIST) "/openlane/designs/test/runs/run5/results/routing/top_test.pnl.v"
set ::env(CURRENT_SDC) "/openlane/designs/test/runs/run5/tmp/21-top_test.sdc"
set ::env(CURRENT_SDF) "/openlane/designs/test/runs/run5/results/signoff/top_test.sdf"
set ::env(CURRENT_SPEF) "/openlane/designs/test/runs/run5/results/routing/mca/process_corner_nom/top_test.spef"
...
set ::env(DESIGN_CONFIG) "/openlane/designs/test/config.tcl"
set ::env(DESIGN_DIR) "/openlane/designs/test"
set ::env(DESIGN_NAME) "top_test"
set ::env(DETAILED_ROUTER) "tritonroute"
set ::env(DIE_AREA) "0.0 0.0 200.0 250.0"
...
set ::env(EXTRA_GDS_FILES) "/openlane/designs/test/macros/test_sram.gds"
set ::env(EXTRA_LEFS) "/openlane/designs/test/macros/test_sram.lef"
...
set ::env(GLB_CFG_FILE) "/openlane/designs/test/runs/run5/config.tcl"
...
set ::env(GRT_CONGESTION_REPORT_FILE) "/openlane/designs/test/runs/run5/tmp/routing/groute-congestion.rpt"
...
set ::env(LAST_TIMING_REPORT_TAG) "/openlane/designs/test/runs/run5/reports/signoff/34-sta-rcx_nom/multi_corner_sta"
set ::env(LEFT_MARGIN_MULT) "12"
set ::env(LIB_CTS) "/openlane/designs/test/runs/run5/tmp/cts/cts.lib"
set ::env(LIB_CTS_FASTEST) "/openlane/designs/test/runs/run5/tmp/cts/cts-fastest.lib"
set ::env(LIB_CTS_SLOWEST) "/openlane/designs/test/runs/run5/tmp/cts/cts-slowest.lib"
...
set ::env(LIB_SYNTH) "/openlane/designs/test/runs/run5/tmp/synthesis/trimmed.lib"
set ::env(LIB_SYNTH_COMPLETE) "/root/.volare/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib"
set ::env(LIB_SYNTH_COMPLETE_NO_PG) "/openlane/designs/test/runs/run5/tmp/synthesis/1-sky130_fd_sc_hd__tt_025C_1v80.no_pg.lib"
set ::env(LIB_SYNTH_MERGED) "/openlane/designs/test/runs/run5/tmp/synthesis/merged.lib"
set ::env(LIB_SYNTH_NO_PG) "/openlane/designs/test/runs/run5/tmp/synthesis/1-trimmed.no_pg.lib"
...
set ::env(LOGS_DIR) "/openlane/designs/test/runs/run5/logs"
set ::env(LVS_CONNECT_BY_LABEL) "0"
set ::env(LVS_INSERT_POWER_PINS) "1"
set ::env(MACRO_BLOCKAGES_LAYER) "li1 met1 met2 met3 met4"
set ::env(MACRO_PLACEMENT_CFG) "/openlane/designs/test/macro_placement.cfg"
...
set ::env(MAGIC_GDS) "/openlane/designs/test/runs/run5/results/signoff/top_test.magic.gds"
...
set ::env(MC_SDF_DIR) "/openlane/designs/test/runs/run5/results/routing/mca/sdf"
set ::env(MC_SPEF_DIR) "/openlane/designs/test/runs/run5/results/routing/mca/spef"
set ::env(MERGED_LEF) "/openlane/designs/test/runs/run5/tmp/merged.nom.lef"
set ::env(MERGED_LEF_MAX) "/openlane/designs/test/runs/run5/tmp/merged.max.lef"
set ::env(MERGED_LEF_MIN) "/openlane/designs/test/runs/run5/tmp/merged.min.lef"
...
set ::env(PARSITICS_CURRENT_DEF) "/openlane/designs/test/runs/run5/results/routing/top_test.def"
set ::env(PDK) "sky130A"
set ::env(PDKPATH) "/root/.volare/sky130A"
set ::env(PLACEMENT_CURRENT_DEF) "/openlane/designs/test/runs/run5/results/floorplan/top_test.def"
...
set ::env(REPORTS_DIR) "/openlane/designs/test/runs/run5/reports"
set ::env(RESULTS_DIR) "/openlane/designs/test/runs/run5/results"
...
set ::env(ROUTING_CURRENT_DEF) "/openlane/designs/test/runs/run5/tmp/cts/18-top_test.resized.def"
...
set ::env(RUN_CTS) "1"
set ::env(RUN_CVC) "1"
set ::env(RUN_DIR) "/openlane/designs/test/runs/run5"
set ::env(RUN_DRT) "1"
...
set ::env(START_TIME) "2026.03.27_03.18.53"
set ::env(STA_EXTRA_LIBS) "/openlane/designs/test/macros/test_sram.lib"
...
set ::env(TMP_DIR) "/openlane/designs/test/runs/run5/tmp"
set ::env(TOP_MARGIN_MULT) "4"
set ::env(TRACKS_INFO_FILE) "/root/.volare/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tracks.info"
set ::env(TRACKS_INFO_FILE_PROCESSED) "/openlane/designs/test/runs/run5/tmp/routing/config.tracks"
...
set ::env(YOSYS_IN) "/openlane/designs/test/macros/test_sram_bb.v"
set ::env(YOSYS_OUT) "/openlane/designs/test/runs/run5/tmp/synthesis/blackbox/extra.v"
set ::env(YOSYS_REWRITE_VERILOG) "0"
set ::env(_PROPAGATE_ALL_CLOCKS) "0"
set ::env(__PL_SKIP_IO) "1"
set ::env(_tmp_drt_file_prefix) "/openlane/designs/test/runs/run5/tmp/routing/drt"
set ::env(_tmp_drt_rpt_prefix) "/openlane/designs/test/runs/run5/reports/routing/drt"
set ::env(cts_logs) "/openlane/designs/test/runs/run5/logs/cts"
set ::env(cts_reports) "/openlane/designs/test/runs/run5/reports/cts"
set ::env(cts_results) "/openlane/designs/test/runs/run5/results/cts"
set ::env(cts_tmpfiles) "/openlane/designs/test/runs/run5/tmp/cts"
set ::env(floorplan_logs) "/openlane/designs/test/runs/run5/logs/floorplan"
set ::env(floorplan_reports) "/openlane/designs/test/runs/run5/reports/floorplan"
set ::env(floorplan_results) "/openlane/designs/test/runs/run5/results/floorplan"
set ::env(floorplan_tmpfiles) "/openlane/designs/test/runs/run5/tmp/floorplan"
set ::env(fp_report_prefix) "/openlane/designs/test/runs/run5/reports/floorplan/3-initial_fp"
set ::env(placement_logs) "/openlane/designs/test/runs/run5/logs/placement"
set ::env(placement_reports) "/openlane/designs/test/runs/run5/reports/placement"
set ::env(placement_results) "/openlane/designs/test/runs/run5/results/placement"
set ::env(placement_tmpfiles) "/openlane/designs/test/runs/run5/tmp/placement"
set ::env(routing_logs) "/openlane/designs/test/runs/run5/logs/routing"
set ::env(routing_reports) "/openlane/designs/test/runs/run5/reports/routing"
set ::env(routing_results) "/openlane/designs/test/runs/run5/results/routing"
set ::env(routing_tmpfiles) "/openlane/designs/test/runs/run5/tmp/routing"
set ::env(signoff_logs) "/openlane/designs/test/runs/run5/logs/signoff"
set ::env(signoff_reports) "/openlane/designs/test/runs/run5/reports/signoff"
set ::env(signoff_results) "/openlane/designs/test/runs/run5/results/signoff"
set ::env(signoff_tmpfiles) "/openlane/designs/test/runs/run5/tmp/signoff"
set ::env(synth_report_prefix) "/openlane/designs/test/runs/run5/reports/synthesis/1-synthesis"
set ::env(synthesis_logs) "/openlane/designs/test/runs/run5/logs/synthesis"
set ::env(synthesis_reports) "/openlane/designs/test/runs/run5/reports/synthesis"
set ::env(synthesis_results) "/openlane/designs/test/runs/run5/results/synthesis"
set ::env(synthesis_tmpfiles) "/openlane/designs/test/runs/run5/tmp/synthesis"
set ::env(timer_end) "1774581564"
set ::env(timer_routed) "1774581557"
set ::env(timer_start) "1774581532"
