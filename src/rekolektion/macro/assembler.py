...
def assemble(p: MacroParams) -> gdstk.Library:
...
def _route_bl(top: gdstk.Cell, p: MacroParams, fp: Floorplan) -> None:
...
def _route_muxed_bl_br(top: gdstk.Cell, p: MacroParams, fp: Floorplan) -> None:
...
def _route_din(top: gdstk.Cell, p: MacroParams, fp: Floorplan) -> None:
...
def _route_dout(top: gdstk.Cell, p: MacroParams, fp: Floorplan) -> None:
