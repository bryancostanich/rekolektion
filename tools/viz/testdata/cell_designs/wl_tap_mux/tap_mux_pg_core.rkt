(layout (version 1)
  ...
  (cell tap_mux_pg_core
    ...
    (rect (layer sky130:via) 22760 -230 22910 -80
      (props (wire-id 33)))
    (rect (layer sky130:tap) 11595 1110 12015 1530)
    (rect (layer sky130:nsdm) 11470 985 12140 1655)
    (rect (layer sky130:licon1) 11720 1235 11890 1405)
    (rect (layer sky130:li1) 11640 1155 11970 1485)
    (rect (layer sky130:mcon) 11720 1235 11890 1405)
    (rect (layer sky130:met1) 11640 1155 11970 1485)
    (label (layer sky130:met1_pin) (text "VDD") (origin 11805 1320)
      (kind port-name))
    (rect (layer sky130:tap) 11595 -610 12015 -190)
    (rect (layer sky130:psdm) 11470 -735 12140 -65)
    (rect (layer sky130:licon1) 11720 -485 11890 -315)
    (rect (layer sky130:li1) 11640 -565 11970 -235)
    (rect (layer sky130:mcon) 11720 -485 11890 -315)
    (rect (layer sky130:met1) 11640 -565 11970 -235)
    (label (layer sky130:met1_pin) (text "VSS") (origin 11805 -400)
      (kind port-name))))
